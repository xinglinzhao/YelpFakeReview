...
def distance_jac(p1,p2):
	...
	if not union:
		...
		return 1 - float(len(inter))/len(union)	
# generalized jaccard distance
def distance_gjac(p1,p2):
	key1 = set(p1.keys())
	key2 = set(p2.keys())
	union = key1.union(key2)
	if not union:
...
if __name__ == '__main__':
	p1 = {'1':4,'2':4,'3':4}
	p2 = {'1':2,'6':2,'4':2}
	print(distance_eu(p1,p2),distance_pearson(p1,p2),distance_jac(p1,p2),distance_gjac(p1,p2))
